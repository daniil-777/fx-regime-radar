...
[![ci](https://github.com/OWNER/REPO/actions/workflows/ci.yml/badge.svg)](https://github.com/OWNER/REPO/actions/workflows/ci.yml) [![daily refresh](https://github.com/OWNER/REPO/actions/workflows/daily.yml/badge.svg)](https://github.com/OWNER/REPO/actions/workflows/daily.yml) [![rust engine](https://github.com/OWNER/REPO/actions/workflows/rust.yml/badge.svg)](https://github.com/OWNER/REPO/actions/workflows/rust.yml) [![live record](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/OWNER/REPO/main/data/badges/live_record.json&style=flat-square)](#track-record--frozen-test-vs-live-forward-record) ![python](https://img.shields.io/badge/python-3.11-8A94A6?style=flat-square) ![use](https://img.shields.io/badge/use-educational-8A94A6?style=flat-square)
